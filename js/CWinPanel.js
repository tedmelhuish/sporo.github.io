function CWinPanel(oSpriteBg) {
    ...
    this._init = function (oSpriteBg) {
        ...
        _oNewScoreTextStroke = new CTLText(_oGroup, 
                    CANVAS_WIDTH / 2 -oSpriteBg.width/2, CANVAS_HEIGHT_HALF-40, oSpriteBg.width, 70, 
                    60, "center", TEXT_COLOR_STROKE, FONT_GAME, 1.1,
                    50, 0,
                    "",
                    true, true, false,
                    false );
        ...
        _oNewScoreText = new CTLText(_oGroup, 
                    CANVAS_WIDTH / 2 -oSpriteBg.width/2, CANVAS_HEIGHT_HALF-40, oSpriteBg.width, 70, 
                    60, "center", TEXT_COLOR, FONT_GAME, 1.1,
                    50, 0,
                    "",
                    true, true, false,
                    false );
        ...
        _oBestScoreTextStroke = new CTLText(_oGroup, 
                    CANVAS_WIDTH / 2 -oSpriteBg.width/2+120, CANVAS_HEIGHT_HALF+40, oSpriteBg.width-240, 70, 
                    60, "center", TEXT_COLOR_STROKE, FONT_GAME, 1.1,
                    0, 0,
                    "",
                    true, true, false,
